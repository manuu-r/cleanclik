...
class DisposalConfirmationDialog extends StatefulWidget {
  ...
  @override
  State<DisposalConfirmationDialog> createState() => _DisposalConfirmationDialogState();
}

class _DisposalConfirmationDialogState extends State<DisposalConfirmationDialog> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text(widget.matchResult.icon, style: const TextStyle(fontSize: 24)),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      elevation: (widget.matchResult.matchingItems.isNotEmpty && !_isDisposing) ? 4 : 0,
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
