...
import '../../core/services/disposal_detection_service.dart';
...
class _DisposalCelebrationOverlayState extends State<DisposalCelebrationOverlay>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: Listenable.merge([_celebrationAnimation, _pointsAnimation, _fadeAnimation]),
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: RadialGradient(
            ...
            radius: 1.5,
            colors: [
              NeonColors.electricGreen.withOpacity(0.2 * _celebrationAnimation.value),
              NeonColors.electricGreen.withOpacity(0.1 * _celebrationAnimation.value),
              Colors.transparent,
            ],
          ),
        ),
