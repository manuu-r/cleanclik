    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Image labeling statistics - Requirements: 6.1, 6.2
          _buildInfoRow(
            'Objects with Labels',
            '${widget.filteredObjects.where((obj) => obj.hasImageLabels).length}/${widget.filteredObjects.length}',
          ),
          if (widget.filteredObjects.any((obj) => obj.hasImageLabels)) ...[
            _buildInfoRow(
              'Total Labels',
              '${widget.filteredObjects.fold<int>(0, (sum, obj) => sum + obj.imageLabels.length)}',
            ),
          ],
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Show remaining objects with image labeling info
          // Requirements: 6.1 - Display image labeling results in debug mode
                ...
                (obj) => Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Show image labeling info if available
                      if (obj.hasImageLabels) ...[
                        Padding(
                          padding: const EdgeInsets.only(left: 8, top: 1),
                          child: Text(
                            'Labels: ${obj.mostConfidentImageLabel?.text ?? 'None'} (${obj.hasImageLabels ? obj.imageLabels.length : 0})',
                            style: const TextStyle(
                              color: Colors.cyan,
                              fontSize: 9,
                            ),
