...
class IntegratedQRScanner extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<IntegratedQRScanner> createState() =>
      _IntegratedQRScannerState();
}
  ...
  Widget build(BuildContext context) {
    ...
    if (cameraState.status == CameraStatus.error) {
      return _buildErrorView(
        cameraState.errorMessage ?? 'Camera error occurred',
      );
    }
  ...
  Widget _buildOverlayUI(BuildContext context) {
    return Stack(
      children: [
        ...
        if (_isScanning) _buildScanLineOverlay(),
                ...
                return Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: NeonColors.electricGreen.withValues(
                            alpha: 0.5,
                          ),
                          blurRadius: 4,
                          spreadRadius: 1,
