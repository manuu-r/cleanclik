...
import 'package:cleanclik/core/services/platform_optimizer.dart';
import '../../core/services/social_sharing_service.dart';
import '../../core/services/social_card_generation_service.dart';
  ...
  Future<void> _generatePreviewCard() async {
    ...
    try {
      ...
      try {
        ...
        print('🎨 Generating ${_selectedTemplate.displayName} card for ${_selectedPlatform.displayName}...');
        ...
        print('⚠️ Social card generation failed (preview still available): $socialCardError');
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed:
                              (_generatedCardFile != null || _previewCard != null) && !_isGenerating
                              ? _shareCard
                              : null,
                          icon: const Icon(
                            Icons.share,
