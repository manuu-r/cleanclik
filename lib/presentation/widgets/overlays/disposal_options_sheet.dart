...
class DisposalOptionsSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Convert bin category String to WasteCategory enum
    final binCategory = WasteCategory.fromString(bin.category);
                ...
                Row(
                  children: [
                    Icon(
                      ...
                      color: binCategory?.color ?? Colors.grey,
                      size: 32,
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            binCategory?.codeName ?? 'General Bin',
