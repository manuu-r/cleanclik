      ...
      body: Stack(
        children: [
          ...
          SingleChildScrollView(
            physics:
                const BouncingScrollPhysics(), // Restore natural scroll physics
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints: const BoxConstraints(
        minHeight: 80,
        maxHeight: 100,
      ), // Proper height for action button content
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(
          UIConstants.radiusRound,
        ), // More circular border radius
        gradient: isPrimary
            ? LinearGradient(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            ), // Reduced padding to fit in smaller container
            child: Column(
