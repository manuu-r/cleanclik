/// Waste categorization models for the CleanClik system
///
/// This file contains the waste categorization logic including:
/// - WasteCategory: Waste disposal categories with ML Kit integration
/// - Category matching and confidence calculation
/// - Comprehensive keyword mappings for waste classification
...
enum WasteCategory {
  ...
  /// Get category from image labeling results with enhanced mapping
  static WasteCategory? fromImageLabel(String label, double confidence) {
    print('🗂️ [WASTE_CATEGORY] ===== PROCESSING IMAGE LABEL =====');
    ...
    // Check image labeling specific mappings first
    final imageLabelMatch = _imageLabelMappings[normalizedLabel];
    if (imageLabelMatch != null) {
      print(
        '🗂️ [WASTE_CATEGORY] ✅ IMAGE LABEL MATCH: $normalizedLabel → ${imageLabelMatch.id}',
      );
      _logDetection(label, confidence, imageLabelMatch, 'Image label mapping');
      return imageLabelMatch;
    }

    // Fall back to existing categorization logic
    final result = _categorizeWithPriority(label, confidence);
    if (result != null) {
      print(
        '🗂️ [WASTE_CATEGORY] ✅ FALLBACK CATEGORIZATION: ${result.category.id}',
      );
      _logDetection(
        label,
        confidence,
    ...
    print('🗂️ [WASTE_CATEGORY] ❌ NO MATCH FOUND');
    _logDetection(label, confidence, null, 'No match found');
    return null;
  }
  ...
  // Image labeling specific mappings for ML Kit Image Labeling integration
  static const Map<String, WasteCategory> _imageLabelMappings = {
    // Common image labels from ML Kit Image Labeling
    'bottle': WasteCategory.recycle,
    'plastic': WasteCategory.recycle,
    'container': WasteCategory.recycle,
    'packaging': WasteCategory.recycle,
    'paper': WasteCategory.recycle,
    'cardboard': WasteCategory.recycle,
    'metal': WasteCategory.recycle,
    'aluminum': WasteCategory.recycle,
    'glass': WasteCategory.recycle,
    'textile': WasteCategory.recycle,
    'clothing': WasteCategory.recycle,
    'fabric': WasteCategory.recycle,

    // Organic waste labels
    'food': WasteCategory.organic,
    'fruit': WasteCategory.organic,
    'vegetable': WasteCategory.organic,
    'plant': WasteCategory.organic,
    'leaf': WasteCategory.organic,
    'flower': WasteCategory.organic,
    'organic matter': WasteCategory.organic,
    'compost': WasteCategory.organic,
    'biodegradable': WasteCategory.organic,

    // Electronic waste labels
    'electronics': WasteCategory.ewaste,
    'device': WasteCategory.ewaste,
    'gadget': WasteCategory.ewaste,
    'computer': WasteCategory.ewaste,
    'phone': WasteCategory.ewaste,
    'tablet': WasteCategory.ewaste,
    'camera': WasteCategory.ewaste,
    'television': WasteCategory.ewaste,
    'appliance': WasteCategory.ewaste,
    'circuit': WasteCategory.ewaste,
    'battery': WasteCategory.ewaste, // Non-hazardous batteries
    'charger': WasteCategory.ewaste,
    'cable': WasteCategory.ewaste,

    // Hazardous waste labels
    'chemical': WasteCategory.hazardous,
    'toxic': WasteCategory.hazardous,
    'hazardous': WasteCategory.hazardous,
    'paint': WasteCategory.hazardous,
    'solvent': WasteCategory.hazardous,
    'medicine': WasteCategory.hazardous,
    'pharmaceutical': WasteCategory.hazardous,
    'cleaning product': WasteCategory.hazardous,
    'pesticide': WasteCategory.hazardous,
    'motor oil': WasteCategory.hazardous,
    'car battery': WasteCategory.hazardous,
    'fluorescent': WasteCategory.hazardous,
  };
