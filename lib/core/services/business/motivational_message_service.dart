...
import 'package:cleanclik/core/services/social/social_sharing_service.dart' show SocialPlatform;
...
final motivationalMessageServiceProvider = Provider<MotivationalMessageService>(
  (ref) {
