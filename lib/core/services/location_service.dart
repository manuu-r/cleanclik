...
class LocationService {
    ...
    try {
      ...
      _positionSubscription = Geolocator.getPositionStream(
        ...
        (Position position) {
          ...
          print('📍 [$_logTag] Location update: ${locationData.position} (±${locationData.accuracy.toStringAsFixed(1)}m)');
        },
        onError: (error) {
  ...
  Future<LocationData?> getCurrentLocation() async {
    try {
      ...
      print('📍 [$_logTag] Current location: ${locationData.position} (±${locationData.accuracy.toStringAsFixed(1)}m)');
      return locationData;
    } catch (e) {
  ...
  Future<bool> _requestLocationPermission() async {
    try {
      ...
      if (permission.isPermanentlyDenied) {
        ...
        print('⚠️ [$_logTag] Location permission permanently denied, opening settings');
