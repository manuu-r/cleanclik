...
class SmartSuggestionsService {
  ...
  Stream<List<SmartSuggestion>> get suggestionsStream => _suggestionsController.stream;
  
  /// Current suggestions
  List<SmartSuggestion> get currentSuggestions => List.unmodifiable(_currentSuggestions);
  
  /// Generate suggestions based on context
  void generateSuggestions(UIContextData context, {
  ...
  void _generateARSuggestions(
    ...
    switch (context.activityState) {
      case ActivityState.idle:
        _addSuggestion(SmartSuggestion(
          id: 'scan_tip',
          type: SuggestionType.tip,
          title: 'Start Scanning',
          description: 'Point your camera at objects to identify waste categories',
          action: 'start_scan',
      ...
      case ActivityState.approaching:
        _addSuggestion(SmartSuggestion(
          ...
          description: 'You\'re near the correct bin. Drop your items to earn points!',
  ...
  void _generateMapSuggestions(
    ...
    _addSuggestion(SmartSuggestion(
      ...
      description: 'Plan an efficient path through multiple cleanup locations',
  ...
  void _generateMissionSuggestions(
    ...
    _addSuggestion(SmartSuggestion(
      ...
      description: 'Complete the "Park Cleanup" mission in the next 2 hours for bonus points',
  ...
  void _addUserBasedSuggestions(Map<String, dynamic> userData) {
    ...
    if (streak > 0 && streak % 5 == 4) {
      _addSuggestion(SmartSuggestion(
        ...
        description: 'One more cleanup today for a ${streak + 1}-day streak bonus',
    ...
    if (totalPoints > 0 && totalPoints % 1000 < 100) {
      _addSuggestion(SmartSuggestion(
        ...
        description: 'You\'re ${1000 - (totalPoints % 1000)} points away from the next milestone',
  ...
  void _addEnvironmentalSuggestions(Map<String, dynamic> environmentData) {
    ...
    if (weather == 'sunny' && timeOfDay == 'morning') {
      _addSuggestion(SmartSuggestion(
        ...
        description: 'Beautiful morning - ideal conditions for outdoor cleanup activities',
...
final smartSuggestionsServiceProvider = Provider<SmartSuggestionsService>((ref) {
