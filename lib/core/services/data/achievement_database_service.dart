...
class AchievementDatabaseService extends DatabaseService<Achievement> {
  ...
  Future<DatabaseResult<List<Achievement>>> findUnlockedByUserId(
    String userId,
  ) async {
  ...
  Future<DatabaseResult<Map<String, dynamic>>> getUserAchievementStats(
    String userId,
  ) async {
    return await executeWithRetry(
      ...
      action: () async {
        ...
        final recentAchievements = response.where((row) {
