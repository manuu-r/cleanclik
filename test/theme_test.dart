...
void main() {
  group('Enhanced Theme System Tests', () {
    ...
    test('NeonColors state layer methods should work correctly', () {
      ...
      expect(
        (hoverColor.a * 255.0).round() & 0xff,
        equals((255 * 0.08).round()),
      );

      final focusColor = NeonColors.getFocusStateLayer(testColor);
      expect(
        (focusColor.a * 255.0).round() & 0xff,
        equals((255 * 0.12).round()),
      );

      final pressedColor = NeonColors.getPressedStateLayer(testColor);
      expect(
        (pressedColor.a * 255.0).round() & 0xff,
        equals((255 * 0.16).round()),
      );
    });

    testWidgets('AppTheme should create valid Material 3 themes', (
      tester,
    ) async {
    ...
    test('AnimationThemeExtension should have enhanced motion system', () {
      ...
      expect(
        animationTheme.motionShort1,
        equals(const Duration(milliseconds: 50)),
      );
      expect(
        animationTheme.motionShort2,
        equals(const Duration(milliseconds: 100)),
      );
      expect(
        animationTheme.motionShort3,
        equals(const Duration(milliseconds: 150)),
      );
      expect(
        animationTheme.motionShort4,
        equals(const Duration(milliseconds: 200)),
      );
      expect(
        animationTheme.motionMedium1,
        equals(const Duration(milliseconds: 250)),
      );
      expect(
        animationTheme.motionMedium2,
        equals(const Duration(milliseconds: 300)),
      );
      expect(
        animationTheme.motionMedium3,
        equals(const Duration(milliseconds: 350)),
      );
      expect(
        animationTheme.motionMedium4,
        equals(const Duration(milliseconds: 400)),
      );
      expect(
        animationTheme.motionLong1,
        equals(const Duration(milliseconds: 450)),
      );
      expect(
        animationTheme.motionLong2,
        equals(const Duration(milliseconds: 500)),
      );
      expect(
        animationTheme.motionLong3,
        equals(const Duration(milliseconds: 550)),
      );
      expect(
        animationTheme.motionLong4,
    ...
    test('AnimationThemeExtension helper methods should work correctly', () {
      ...
      expect(
        animationTheme.microInteractionDuration,
        equals(const Duration(milliseconds: 50)),
      );
      expect(
        animationTheme.simpleTransitionDuration,
        equals(const Duration(milliseconds: 100)),
      );
      expect(
        animationTheme.componentChangeDuration,
        equals(const Duration(milliseconds: 200)),
      );
      expect(
        animationTheme.screenTransitionDuration,
        equals(const Duration(milliseconds: 350)),
      );
      expect(
        animationTheme.complexAnimationDuration,
        equals(const Duration(milliseconds: 500)),
      );

      // Test helper method curves
      expect(
        animationTheme.microInteractionEasing,
        equals(Curves.easeOutQuint),
      );
      expect(animationTheme.standardTransitionEasing, equals(Curves.easeInOut));
      expect(
        animationTheme.emphasizedTransitionEasing,
