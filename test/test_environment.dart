...
class TestEnvironment {
  ...
  static void _setUpMockMethodChannels() {
    ...
    TestUtils.setUpMockMethodChannel('plugins.flutter.io/camera', {
      'availableCameras': [
        {
          'name': 'test_camera',
          'lensDirection': 'back',
    ...
    TestUtils.setUpMockMethodChannel('flutter.baseflow.com/geolocator', {
      'getCurrentPosition': {
    ...
    TestUtils.setUpMockMethodChannel('plugins.flutter.io/google_sign_in', {
      'init': null,
      'signIn': {
    ...
    TestUtils.setUpMockMethodChannel('plugins.flutter.io/shared_preferences', {
    ...
    TestUtils.setUpMockMethodChannel('google_mlkit_object_detection', {
  ...
  static ProviderContainer createTestContainer({
    ...
    return ProviderContainer(overrides: [..._globalOverrides, ...overrides]);
  }
