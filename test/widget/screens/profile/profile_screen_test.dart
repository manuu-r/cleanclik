...
class ProfileScreenWidgetTest extends BaseWidgetTest {
  ...
  void setUpWidgetTest() {
    ...
    when(
      mockInventoryService.items,
    ).thenReturn(TestDataFactory.createMockInventoryItems(count: 15));
...
void main() {
  group('ProfileScreen Widget Tests', () {
    ...
    testWidgets('should display profile screen with basic structure', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should display user rank from leaderboard service', (
      tester,
    ) async {
      // Arrange
      const screen = ProfileScreen();
    ...
    testWidgets('should display inventory statistics', (tester) async {
      ...
      expect(find.byType(Scaffold), findsOneWidget);
      verify(
        testHelper.mockInventoryService.totalItemsCollected,
    ...
    testWidgets('should handle unauthenticated state', (tester) async {
      ...
      when(
        testHelper.mockAuthService.authStateStream,
      ).thenAnswer((_) => Stream.value(unauthenticatedState));
    ...
    testWidgets('should display loading state when auth is loading', (
      tester,
    ) async {
      // Arrange
      final loadingState = AuthState(status: AuthStatus.loading, user: null);
  ...
  group('ProfileScreen Integration Tests', () {
    ...
    testWidgets('should integrate with leaderboard service for ranking', (
      ...
      // Assert - Profile screen rendered successfully
    });
