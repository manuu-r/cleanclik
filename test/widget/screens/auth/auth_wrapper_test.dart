...
class AuthWrapperWidgetTest extends BaseWidgetTest {
  ...
  void configureAuthState(AuthState state) {
    ...
    ).thenReturn(state.status == AuthStatus.authenticated);
  }
}
...
void main() {
  group('AuthWrapper Widget Tests', () {
    ...
    testWidgets('should display loading indicator when auth is loading', (
      ...
      // Arrange
      testHelper.configureAuthState(
        const AuthState(status: AuthStatus.loading, user: null),
      );

      const authWrapper = AuthWrapper(child: Text('Protected Content'));
    ...
    testWidgets('should redirect to login when user is unauthenticated', (
      tester,
    ) async {
      // Arrange
      testHelper.configureAuthState(
    ...
    testWidgets('should display error message when auth has error', (
      tester,
    ) async {
      // Arrange
      testHelper.configureAuthState(
  ...
  group('AuthWrapper Material 3 Theme Tests', () {
    ...
    testWidgets('should apply Material 3 design to loading state', (
      tester,
    ) async {
      // Arrange
      testHelper.configureAuthState(
    ...
    testWidgets('should apply Material 3 design to error state', (
      tester,
    ) async {
      // Arrange
      testHelper.configureAuthState(
