...
class EmailVerificationScreenWidgetTest extends BaseWidgetTest {
  ...
  void setUpWidgetTest() {
    ...
    when(
      mockAuthService.handleEmailVerificationComplete(),
    ).thenAnswer((_) async {});
...
void main() {
  group('EmailVerificationScreen Widget Tests', () {
    ...
    testWidgets(
      'should display email verification screen with basic structure',
      (tester) async {
        // Arrange
    ...
    testWidgets('should display email verification title and message', (
      tester,
    ) async {
      // Arrange
      const screen = EmailVerificationScreen(email: 'test@example.com');
      ...
      expect(
        find
            ...
            .or(find.text('Check your email for verification')),
    ...
    testWidgets('should display email verification icon', (tester) async {
      ...
      expect(
        find
            .byIcon(Icons.email_outlined)
            .or(find.byIcon(Icons.mark_email_unread_outlined)),
        findsAtLeastNWidgets(1),
      );
    });
    ...
    testWidgets('should handle resend verification email', (tester) async {
      ...
      final resendButton = find
          .text('Resend Email')
          .or(find.text('Resend Verification'));
    ...
    testWidgets('should display success message after verification', (
      tester,
    ) async {
      // Arrange
      const screen = EmailVerificationScreen(email: 'test@example.com');
      ...
      when(
        testHelper.mockAuthService.handleEmailVerificationComplete(),
      ).thenAnswer((_) async {});
    ...
    testWidgets('should display loading state during verification check', (
      tester,
    ) async {
      // Arrange
      when(
    ...
    testWidgets('should display help or support information', (tester) async {
      ...
      // Assert
      expect(
        find.text('Need help?').or(find.text('Didn\'t receive the email?')),
        findsAtLeastNWidgets(1),
      );
    });
    ...
    testWidgets('should handle spam folder reminder', (tester) async {
      ...
      // Assert
      expect(
        find.text('Check your spam folder').or(find.text('spam')),
        findsAtLeastNWidgets(1),
      );
    });
    ...
    testWidgets('should handle app lifecycle changes gracefully', (
      tester,
    ) async {
      // Arrange
      const screen = EmailVerificationScreen(email: 'test@example.com');
