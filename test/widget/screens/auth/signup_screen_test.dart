...
void main() {
  group('SignUpScreen Widget Tests', () {
    ...
    testWidgets('should display sign up screen with basic structure', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should handle successful sign up', (tester) async {
      ...
      // Assert
      verify(
        testHelper.mockAuthService.signUpWithEmail(
          'test@example.com',
          'password123',
          'testuser',
        ),
    ...
    testWidgets('should display error message on sign up failure', (
      ...
      // Arrange
      when(
        testHelper.mockAuthService.signUpWithEmail(any, any, any),
      ).thenAnswer(
