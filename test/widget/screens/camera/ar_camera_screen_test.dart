...
void main() {
  group('ARCameraScreen Widget Tests', () {
    ...
    testWidgets('should display loading indicator when not initialized', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should initialize with ML detection mode by default', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should initialize with QR scanning mode when specified', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should have black background for AR camera interface', (
      tester,
    ) async {
      // Arrange
      const screen = ARCameraScreen(initialMode: CameraMode.mlDetection);
    ...
    testWidgets(
      'should display camera view in ML detection mode when initialized',
      (tester) async {
  ...
  group('ARCameraScreen Integration Tests', () {
    ...
    testWidgets('should integrate with bin location service', (tester) async {
      ...
      // Assert
      verify(
        testHelper.mockBinLocationService.nearbyBins,
