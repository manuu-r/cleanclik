...
class HomeScreenWidgetTest extends BaseWidgetTest {
  ...
  void setUpWidgetTest() {
    ...
    ).thenReturn(TestDataFactory.createMockInventoryItems(count: 5));
...
void main() {
  group('HomeScreen Widget Tests', () {
    ...
    testWidgets('should display home screen with basic structure', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should display user greeting when authenticated', (
      tester,
    ) async {
      // Arrange
      const screen = HomeScreen();
      ...
      expect(
        find
            .text('Hello, ${mockUser.username}!')
            .or(find.text('Welcome back, ${mockUser.username}')),
    ...
    testWidgets('should display main camera action button', (tester) async {
      ...
      // Assert
      expect(
        WidgetTestHelpers.findAny([
          find.text('Start Scanning'),
          find.text('Scan Objects'),
        ]),
        findsAtLeastNWidgets(1),
      );
      expect(
    ...
    testWidgets('should handle camera action button tap', (tester) async {
      ...
      final cameraButton = WidgetTestHelpers.findAny([
        find.text('Start Scanning'),
        find.text('Scan Objects'),
      ]);
    ...
    testWidgets('should display loading state when data is loading', (
      tester,
    ) async {
      // Arrange
    ...
    testWidgets('should handle unauthenticated state', (tester) async {
      ...
      when(
        testHelper.mockAuthService.currentState,
    ...
    testWidgets('should display demo mode indicator when in demo mode', (
      tester,
    ) async {
      // Arrange
      final mockUser = TestDataFactory.createMockUser();
  ...
  group('HomeScreen Integration Tests', () {
    ...
    testWidgets('should integrate with auth service for user data', (
      tester,
    ) async {
      // Arrange
      const screen = HomeScreen();
    ...
    testWidgets('should integrate with inventory service for stats', (
      tester,
    ) async {
      // Arrange
      const screen = HomeScreen();
    ...
    testWidgets('should integrate with leaderboard service for ranking', (
      tester,
    ) async {
      // Arrange
      const screen = HomeScreen();
      ...
      // Assert - Home screen rendered successfully
    });
  ...
  group('HomeScreen Material 3 Theme Tests', () {
    ...
    testWidgets('should be accessible with proper semantics', (tester) async {
      ...
      expect(
        WidgetTestHelpers.findAny([
          find.bySemanticsLabel('Home screen'),
