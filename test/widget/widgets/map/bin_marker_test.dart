  ...
  group('BinMarker Widget Tests', () {
    ...
    group('Basic Rendering', () {
      testWidgets('should render recycling bin marker', (tester) async {
        ...
        final widget = BinMarker(bin: binData, onTap: (bin) => tappedBin = bin);
    ...
    group('Interaction Handling', () {
      testWidgets('should handle tap events and pass correct bin data', (
        tester,
      ) async {
        // Arrange
        BinData? tappedBin;
      ...
      testWidgets('should handle multiple taps', (tester) async {
        ...
        final widget = BinMarker(bin: binData, onTap: (bin) => tapCount++);
    ...
    group('Visual Styling', () {
      ...
      testWidgets('should use correct colors for different bin types', (
        tester,
      ) async {
        final binTypes = [
          'recycling',
        ...
        for (final binType in binTypes) {
          ...
          await tester.pumpWidget(
            WidgetTestHelpers.createTestApp(child: widget),
          );
          await tester.pumpAndSettle();
      ...
      testWidgets('should show white icon on colored background', (
        tester,
      ) async {
        // Arrange
        final binData = const BinData(
    ...
    group('Icon Selection', () {
      testWidgets('should use delete_outline icon for recycling bins', (
        tester,
      ) async {
        // Arrange
        final binData = const BinData(
      ...
      testWidgets('should use electrical_services icon for e-waste bins', (
        tester,
      ) async {
        // Arrange
        final binData = const BinData(
      ...
      testWidgets('should use default icon for unknown bin types', (
        tester,
      ) async {
        // Arrange
        final binData = const BinData(
    ...
    group('BinData Model', () {
      testWidgets('should handle all BinData properties correctly', (
        tester,
      ) async {
        // Arrange
        BinData? receivedBin;
