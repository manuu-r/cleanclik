  ...
  group('Camera Mode Switching Widget Tests', () {
    ...
    group('Mode Indicator', () {
      testWidgets('should show ML detection mode indicator', (tester) async {
        ...
        expect(
          find.text('Point camera at objects to detect waste category'),
          findsOneWidget,
        );
        expect(find.byIcon(Icons.camera_alt), findsOneWidget);
      });
      ...
      testWidgets('should show QR scanning mode indicator', (tester) async {
        ...
        expect(
          find.text('Scan QR codes on bins to identify disposal location'),
          findsOneWidget,
        );
        expect(find.byIcon(Icons.qr_code_scanner), findsOneWidget);
      });

      testWidgets('should show different colors for different modes', (
        tester,
      ) async {
    ...
    group('Mode Switching Animation', () {
      ...
      testWidgets('should show transition animation between modes', (
        tester,
      ) async {
        // Arrange
    ...
    group('Mode Status Display', () {
      ...
      testWidgets('should show ready status when not processing', (
        tester,
      ) async {
        // Arrange
        final widget = _CameraModeStatusWidget(
    ...
    group('Mode Selection Panel', () {
      testWidgets('should render mode selection panel with both options', (
        tester,
      ) async {
        // Arrange
        CameraMode? selectedMode;
    ...
    group('Accessibility', () {
      testWidgets('should have proper semantic labels for mode buttons', (
        tester,
      ) async {
        // Arrange
        final widget = _CameraModeToggleWidget(
...
class _CameraModeToggleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return NeonIconButton.primary(
      ...
      onTap: () {
        onModeChanged(
          isMLMode ? CameraMode.qrScanning : CameraMode.mlDetection,
        );
      },
