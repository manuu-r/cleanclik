...
void main() {
  group('QRScannerOverlay Widget Tests', () {
    ...
    group('Basic Rendering', () {
      testWidgets('should render QR scanner overlay with all UI elements', (
        tester,
      ) async {
        // Arrange
        String? scannedData;
      ...
      testWidgets('should show loading state initially', (tester) async {
        // Arrange
        final widget = QRScannerOverlay(onQRScanned: (data) {}, onClose: () {});
    ...
    group('QR Code Detection', () {
      testWidgets('should call onQRScanned when QR code is detected', (
        tester,
      ) async {
        // Arrange
        String? scannedData;
    ...
    group('UI States', () {
      testWidgets('should show scanning instructions when active', (
        tester,
      ) async {
        // Arrange
        final widget = QRScannerOverlay(onQRScanned: (data) {}, onClose: () {});
        ...
        expect(
          find.text('Make sure the code is well-lit and clearly visible'),
          findsOneWidget,
        );
      });
