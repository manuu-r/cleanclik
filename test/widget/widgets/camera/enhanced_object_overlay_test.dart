...
void main() {
  group('EnhancedObjectOverlay Widget Tests', () {
    ...
    group('Tooltip Display', () {
      testWidgets('should show tooltip when enabled and confidence is high', (
        tester,
      ) async {
        // Arrange
        final detectedObject = TestDataFactory.createMockDetectedObject(
      ...
      testWidgets('should not show tooltip when confidence is low', (
        tester,
      ) async {
        // Arrange
        final detectedObject = TestDataFactory.createMockDetectedObject(
    ...
    group('Confidence Indicators', () {
      testWidgets('should display different opacity based on confidence', (
        tester,
      ) async {
        // Arrange
    ...
    group('Category-Specific Rendering', () {
      testWidgets(
        'should render different colors for different waste categories',
        (tester) async {
          final categories = [
    ...
    group('Animation States', () {
      testWidgets('should enable animations for carried objects', (
        tester,
      ) async {
        // Arrange
        final detectedObject = TestDataFactory.createMockDetectedObject();
      ...
      testWidgets('should enable animations for targeted objects', (
        tester,
      ) async {
        // Arrange
        final detectedObject = TestDataFactory.createMockDetectedObject();
