...
void main() {
  group('DetailCard Widget Tests', () {
    ...
    group('Bin Detail Card', () {
      testWidgets('should render bin detail card with all information', (
        tester,
      ) async {
        // Arrange
        bool closed = false;
      ...
      testWidgets('should show correct icon and color for recycling bin', (
        tester,
      ) async {
        // Arrange
        final widget = DetailCard(
    ...
    group('Mission Detail Card', () {
      testWidgets('should render mission detail card', (tester) async {
        ...
        expect(
          find.text('objective: Collect 10 recyclable items'),
          findsOneWidget,
        );
    ...
    group('Fill Level Display', () {
      testWidgets('should show fill level progress bar for bins', (
        tester,
      ) async {
        // Arrange
        final details = {'type': 'Recycling', 'fillLevel': 60};
      ...
      testWidgets('should not show fill level for non-bin types', (
        tester,
      ) async {
        // Arrange
        final details = {
    ...
    group('Visual Styling', () {
      ...
      testWidgets('should show proper text styling', (tester) async {
        ...
        final widget = DetailCard(
          type: DetailType.bin,
          title: 'Recycling Bin #001',
          details: {'type': 'Recycling', 'location': 'Main Street'},
          actions: [],
          onClose: () {},
        );
