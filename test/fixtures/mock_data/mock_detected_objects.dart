...
class MockDetectedObjects {
  ...
  static List<Map<String, dynamic>> createMockDetectedObjects({
    ...
    return List.generate(count, (index) {
      ...
      final labels =
          TestConfig.wasteCategories[objectCategory.name] ?? ['Unknown Object'];
      final confidence =
  ...
  static List<Map<String, dynamic>> createHighConfidenceObjects({
    ...
    return createMockDetectedObjects(count: count, minConfidence: 0.9);
  }
  ...
  static List<Map<String, dynamic>> createLowConfidenceObjects({
    ...
    return createMockDetectedObjects(count: count, minConfidence: 0.5);
  }
  ...
  static List<Map<String, dynamic>> createTrackingPerformanceObjects({
    ...
    return List.generate(count, (index) {
      ...
      return {
        ...
        'trackingId': index,
        'trackingHistory': List.generate(
          5,
          (historyIndex) => {
            'timestamp': DateTime.now()
                .subtract(Duration(milliseconds: historyIndex * 100))
                .toIso8601String(),
            'boundingBox': {
  ...
  static Map<String, dynamic> createDetectionStatistics({String? userId}) {
    return {
