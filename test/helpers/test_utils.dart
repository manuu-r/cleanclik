...
class TestUtils {
  ...
  static Future<void> simulateMLProcessingDelay([Duration? delay]) async {
    final random = Random();
    final processingDelay =
        delay ?? Duration(milliseconds: 50 + random.nextInt(100));
  ...
  static void verifyMockCall(
    ...
    verify(mock.noSuchMethod(Invocation.method(Symbol(method), arguments)));
  }
  ...
  static void verifyPerformanceThreshold(
    ...
    expect(
      ...
      lessThan(threshold),
      reason:
          '$operation took ${actualTime.inMilliseconds}ms, '
