...
// Auth providers
final authStateProvider = StateProvider<AsyncValue<Map<String, dynamic>>>((
  ref,
) {
  return const AsyncValue.loading();
});

final userProfileProvider = StateProvider<AsyncValue<Map<String, dynamic>>>((
  ref,
) {
  return const AsyncValue.loading();
});
...
final detectedObjectsProvider = StateProvider<List<Map<String, dynamic>>>((
  ref,
) {
  return [];
});
...
// Location providers
final binLocationsProvider =
    StateProvider<AsyncValue<List<Map<String, dynamic>>>>((ref) {
      return const AsyncValue.loading();
    });

final userLocationProvider = StateProvider<AsyncValue<Map<String, dynamic>>>((
  ref,
) {
  return const AsyncValue.loading();
});
...
final userStatsProvider = StateProvider<AsyncValue<Map<String, dynamic>>>((
  ref,
) {
  return const AsyncValue.loading();
});
...
// Enum definitions for golden tests are now imported from the app source.
