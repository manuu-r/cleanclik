...
void main() {
  group('Navigation Shell Golden Tests', () {
    ...
    group('ARNavigationShell', () {
      testGoldens('ARNavigationShell renders correctly in light theme', (
        tester,
      ) async {
        await loadAppFonts();
        ...
        final widget = baseTest.createTestWidget(
          ...
          overrides: [
            ...
            currentNavigationIndexProvider.overrideWith(
              (ref) => 0,
            ), // Camera tab
            cameraStateProvider.overrideWith(
              (ref) => {'mode': 'ml_detection', 'status': 'active'},
            ),
            detectedObjectsProvider.overrideWith(
      ...
      testGoldens('ARNavigationShell renders correctly in dark theme', (
        tester,
      ) async {
        await loadAppFonts();
      ...
      testGoldens('ARNavigationShell with map tab selected', (tester) async {
        ...
        final widget = baseTest.createTestWidget(
          ...
          overrides: [
            ...
            binLocationsProvider.overrideWith(
              (ref) => const AsyncValue.data([
                {
                  'id': 'bin1',
                  'type': 'recycle',
            ...
            userLocationProvider.overrideWith(
              (ref) =>
                  const AsyncValue.data({'lat': 37.7749, 'lng': -122.4194}),
            ),
          ],
        );
      ...
      testGoldens('ARNavigationShell with profile tab selected', (
        tester,
      ) async {
        await loadAppFonts();
    ...
    group('HomeScreen', () {
      testGoldens('HomeScreen renders correctly in light theme', (
        tester,
      ) async {
        await loadAppFonts();
