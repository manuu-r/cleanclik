...
void main() {
  group('AR Overlay Components Golden Tests', () {
    ...
    group('DisposalCelebrationOverlay', () {
      ...
      testGoldens('DisposalCelebrationOverlay with achievement', (
        tester,
      ) async {
        await loadAppFonts();
      ...
      testGoldens('DisposalCelebrationOverlay with streak multiplier', (
        tester,
      ) async {
        await loadAppFonts();
    ...
    group('Multiple Overlays', () {
      testGoldens('Multiple AR overlays with different categories', (
        tester,
      ) async {
        await loadAppFonts();
