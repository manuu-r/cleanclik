      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            // Demo mode
            TextButton(onPressed: () {}, child: const Text('Try Demo Mode')),
          ],
        ),
      ),
    );
      ...
      body: const Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 32),
            ElevatedButton(onPressed: null, child: Text('Resend Email')),
          ],
        ),
      ),
    );
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              const Expanded(child: ARNavigationShell()),
            ],
          ),
        );
      },
