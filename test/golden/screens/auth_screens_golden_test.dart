...
void main() {
  group('Authentication Screens Golden Tests', () {
    ...
    group('LoginScreen', () {
      testGoldens('LoginScreen renders correctly in light theme', (
        tester,
      ) async {
        await loadAppFonts();
        ...
        final widget = baseTest.createTestWidget(
          ...
          overrides: [
            authStateProvider.overrideWith(
              (ref) =>
                  const AsyncValue.data({'status': 'signed_out', 'user': null}),
            ),
          ],
        );
      ...
      testGoldens('LoginScreen renders correctly in dark theme', (
        tester,
      ) async {
        await loadAppFonts();
      ...
      testGoldens('LoginScreen with loading state', (tester) async {
        ...
        final widget = baseTest.createTestWidget(
          ...
          overrides: [
            authStateProvider.overrideWith(
              (ref) => const AsyncValue<Map<String, dynamic>>.loading(),
            ),
          ],
        );
      ...
      testGoldens('LoginScreen with error state', (tester) async {
        ...
        final widget = baseTest.createTestWidget(
          ...
          overrides: [
            authStateProvider.overrideWith(
              (ref) => const AsyncValue<Map<String, dynamic>>.error(
    ...
    group('SignUpScreen', () {
      testGoldens('SignUpScreen renders correctly in light theme', (
        tester,
      ) async {
        await loadAppFonts();
      ...
      testGoldens('SignUpScreen renders correctly in dark theme', (
        tester,
      ) async {
        await loadAppFonts();
